...
class Encoder(chainer.Chain):
    def __init__(self, in_ch=1):
        ...
        layers['c3'] = CBR(256, 256, bn=True, sample='down', activation=F.leaky_relu, dropout=False)
        ...
        layers['c6'] = CBR(256, 256, bn=True, sample='down', activation=F.leaky_relu, dropout=False)
        layers['c7'] = CBR(256, 256, bn=True, sample='down', activation=F.leaky_relu, dropout=False)
...
class Decoder(chainer.Chain):
    def __init__(self, out_ch=1):
        ...
        layers['c1'] = CBR(256, 256, bn=True, sample='up', activation=F.relu, dropout=True)
        ...
        layers['c4'] = CBR(256, 256, bn=True, sample='up', activation=F.relu, dropout=False)
        layers['c5'] = CBR(256, 128, bn=True, sample='up', activation=F.relu, dropout=False)
        layers['c6'] = L.DeconvolutionND(3, 128, out_ch, 3, 1, 1, initialW=w)
        layers['c7'] = L.DeconvolutionND(3, out_ch, 1, 3, 1, 1, initialW=w)
